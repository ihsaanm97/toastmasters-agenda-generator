...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $listener_time = $_POST['listener_time'];
...
<head>
    ...
    <meta name="keywords" content="Toastmasters, Agenda, Meeting, GSC, Goregaon Speakers">
    ...
    <header>
        <img src="GSC Agenda Header2.jpg" alt="GSC Web Header">
    </header>
                ...
                <table id="left-inner-table">
                    ...
                    <tr>                                <!--President-->
                        <td>                
                            ...
                            <div class="xcom-name">Akshay Singh</div>
                        </td>
                    </tr>
                    <tr>                                <!--Vice President Education-->
                        <td>                
                            <div class="xcom-title">VP Education</div>
                            <div class="xcom-name">Deepak Shetty</div>
                        </td>
                    </tr>
                    <tr>                                <!--Vice President Membership-->
                        <td>                
                            <div class="xcom-title">VP Membership</div>
                            <div class="xcom-name">Amit Dudani</div>
                        </td>
                    </tr>
                    <tr>                                <!--Vice President Public Relations-->
                        <td>                
                            <div class="xcom-title">VP Public Relations</div>
                            <div class="xcom-name">Rupali Tiwari</div>
                        </td>
                    </tr>
                    <tr>                                <!--Secretary-->
                        <td>                
                            <div class="xcom-title">Secretary</div>
                            <div class="xcom-name">Sarita Shetty</div>
                        </td>
                    </tr>
                    <tr>                                <!--Treasurer-->
                        <td>                
                            <div class="xcom-title">Treasurer</div>
                            <div class="xcom-name">Khushboo Tanna</div>
                        </td>
                    </tr>
                    <tr>                                <!--Sergeant at Arms-->
                        <td>                
                            <div class="xcom-title">Sergeant at Arms</div>
                            <div class="xcom-name">Deepti Pandit</div>
                        </td>
                    </tr>
                    <tr >                                <!--Schedule-->
                        <td>
                            <div style="font-weight: bold; margin-top:15px;">We meet Every Sunday from 3pm to 5pm.</div>
                    </tr>
                    ...
                    <tr class="additional-info">                                <!--Contact Us-->
                        <td>                
                            ...
                            <div class="contact-name">Akshay Singh - <a style="font-weight:normal" class="contact-anchor" href="https://wa.me/918169365428">+91 81693 65428</a></div>
                            <div class="contact-name">Amit Dudani - <a style="font-weight:normal" class="contact-anchor" href="https://wa.me/919920785841">+91 99207 85841</a></div>                            
                        </td>
                    </tr>
                    <tr class="additional-info">                                <!--Contact Us-->
                        <td>                
                            <div class="additional-info-header">Follow Us On</div>
                            <div class="contact-name"><a style="font-weight:normal;" class="contact-anchor" href="https://www.facebook.com/groups/goregoan.speakers.community.toastmasters.club">Facebook</a></div>
                            <div class="contact-name"><a style="font-weight:normal" class="contact-anchor" href="https://www.instagram.com/gsctoastmastersclub/">Instagram</a></div>                            
                        </td>
                    </tr>
        ...
        empowered to develop communication and leadership skills, resulting in greater self-confidence and personal growth.</div>
            ...
            <td id="right-table-cell" style="padding-right: 5px;">
                <table id="right-inner-table" style=" width: 100%;">
                    ...
                    <tr>
                        <td class="time-td">13:30</td><td class="normal-text">Role Players Discussion to Know Your Role Responsiblities.</td><td class="normal-text">All</td>
                    </tr>
                    <tr class="empty-tr">
                    ...
                    <tr>
                        <td class="time-td"></td><td class="normal-text">Listener</td><td class="normal-text"><?php echo $listener; ?></td>
                    </tr>
                    <tr class="empty-tr">
                    ...
                    <tr>
                        <td class="time-td"><?php echo $listener_time;?></td><td class="normal-text">Listener</td><td class="normal-text"><?php echo $listener; ?></td>
                    </tr>             
